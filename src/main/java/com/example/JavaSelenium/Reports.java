...
public class Reports {
	...
	public static void main(String[] args) throws ClassNotFoundException, IOException {
		...
		scenario.createNode(new GherkinKeyword("Given"), "I navigate to page")
				.addScreenCaptureFromPath(captureScreenshots(driver, "img1.jpg"), "I navigate to page").pass("pass");
